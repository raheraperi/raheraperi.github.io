...
var pg = {
	...
	languageParts: {
		...
		'adverb': 'quickly|slowly|boldly|always|angrily|cheerfully|elegantly|frantically|innocently|nervously|powerfully|rarely|silently|wildly|warmly'.split('|'),
		'noun': 'crystal|finger|sun|field|arm|sphere|rock|sand|grass|tree|flower|orb|sea|water|ocean|tide|sky|cloud|moon|star|cosmos|ant|planet|elephant|heart|ring'.split('|'),
		'pronoun': 'he|she|it|someone|they'.split('|'),
		'verb': 'kicks|moves|swings|runs|walks|flies|sprays|stings|drops|breaks|explodes|diminishes|sweetens|falls|rises|hears|floats|kisses|hugs|loves|dances|boogies'.split('|'),
		'stop': '.|?|!'.split('|'),
		'pause': ',|;|...| - |'.split('|')
	},
	// -- setup  --------------------------------------------------------------
